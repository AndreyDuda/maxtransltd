...
if ($cleanPost['request'] === 'add_stop') {
   ...
   if ($addStop){
       ...
       $stopInfo = $Db->getOne("SELECT ts.arrival_time,ts.departure_time,ts.stop_num,ts_arrival_day,city.title_".$Admin->lang." AS city,station.title_".$Admin->lang." AS station FROM ".DB_PREFIX."_tours_stops ts
