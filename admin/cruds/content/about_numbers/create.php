...
require_once $_SERVER['DOCUMENT_ROOT'] . '/' . ADMIN_PANEL . '/guard.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/' . ADMIN_PANEL . '/includes.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($Admin->CheckPermission($_params['access_edit'])) {
        ...
        if (!empty($_FILES['image']['tmp_name'])) {
            require_once $_SERVER['DOCUMENT_ROOT'] . '/' . ADMIN_PANEL . '/engine/CImageProcessor.php';
