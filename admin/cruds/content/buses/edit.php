...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        if (isset($_POST['delete_image'])) {
            ...
            $filePath = $_SERVER['DOCUMENT_ROOT'] . '/' . $_params['image'] . $image;
        ...
        if (isset($_POST['ok']) && $Admin->CheckPermission($_params['access_edit'])) {
            ...
            if (isset($_FILES['images']['name'][0]) && $_FILES['image']['tmp_name'] != '') {
                ...
                $uploadPath = $_SERVER['DOCUMENT_ROOT'] . '/' . $_params['image'] . $FileName;
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    while ($image = mysqli_fetch_array($images)) {
                                        ...
                                        echo '<img style="max-width: 300px;" src="' . $_params['image'] . $image['bus_img'] . '"/>';
