            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <a class="btn btn-success float-right" role="button" href="create.php?parent=<?=$parent?>&city=<?=(int)$_GET['city']?>">
                        ...
                        <table class="table m-0">
                            ...
                            while ($Elem = mysqli_fetch_assoc($getTableElems)) {
                                ...
                                <?} else { ?> class="fas fa-toggle-on" <?} ?>></i>
                                            ...
                                            <a href="edit.php?id=<?= $Elem['id'] ?>&parent=<?=$parent?>&city=<?=(int)$_GET['city']?>" class="btn btn-default"
                                               title="Редактировать">
