...
$getSection = mysqli_query($db,"SELECT * FROM ".DB_PREFIX."_menu_admin WHERE link = '".$pathSection."'");
...
// параметры раздела
$getSectionParams = mysqli_query($db,"SELECT * FROM ".DB_PREFIX."_menu_admin_settings WHERE section_id = ".$Section['id']);
