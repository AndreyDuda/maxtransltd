        ...
        <? if (isset($_POST['ok']) && $Admin->CheckPermission($_params['access_edit'])) {
            ...
            foreach ($Admin->langs as $key => $value) {
                ...
                if (isset($_FILES['white_logo_'.$value['code']]['tmp_name']) && $_FILES['white_logo_'.$value['code']]['tmp_name'] != '') {
                    ...
                    $outputPath = $_SERVER['DOCUMENT_ROOT'] . '/'.$_params['white_logo'].$FileNameWhite;
                ...
                if (isset($_FILES['black_logo_'.$value['code']]['tmp_name']) && $_FILES['black_logo_'.$value['code']]['tmp_name'] != '') {
                    ...
                    $outputPath = $_SERVER['DOCUMENT_ROOT'] . '/'.$_params['black_logo'].$FileName;
                        ...
                        <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
                            <?foreach ($Admin->langs as $key => $value) {?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <img style="max-width: 300px;" src="<?=$_params['white_logo'].$Elem['white_logo_'.$value['code']]?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <img style="max-width: 300px;" src="<?=$_params['black_logo'].$Elem['black_logo_'.$value['code']]?>" />
