...
<div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/<?php echo ADMIN_PANEL ?>/template/dist/img/AdminLTELogo.png" alt="AdminLTELogo"
         height="60" width="60">
</div>
...
<aside class="main-sidebar <?php echo $adminTheme['aside_class'] ?> elevation-4">
    ...
    <a href="/<?php echo ADMIN_PANEL ?>/" class="brand-link">
        <img src="/<?php echo ADMIN_PANEL ?>/template/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/<?php echo ADMIN_PANEL ?>/images/admin_avatars/<?= $Admin->image ?>"
                    ...
                    <li class="nav-item <?=$actClass?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            foreach ($getSubmenuItems AS $key=>$submenuItem){
                                ...
                                $actSubclass = '';
                                if( substr_count($_SERVER['REQUEST_URI'], $submenuItemPath) ){
                                    $actSubclass = 'active';
                                }?>
                            <li class="nav-item">
                                <a href="<?=$submenuItemPath?>" class="nav-link <?=$actSubclass?>">
