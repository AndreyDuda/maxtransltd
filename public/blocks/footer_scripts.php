<script src="/public/libs/jquery/jquery.3.7.0.js"></script>
<script src="/public/libs/nice_select/jquery.nice-select.min.js"></script>
<script src="/public/libs/slick/slick.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
<script src="https://npmcdn.com/flatpickr/dist/l10n/<?=$Router->lang?>.js"></script>
...
<script>
    ...
    $('.cb_phone_input').mask("<?=$firstPhoneMask?>");
    ...
    function exitAccount(){
        ...
        $.ajax({
            ...
            success:function(response){
                location.href = '<?=$Router->writelink(1)?>';
            }
        })
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateSessionDate(date) {
        $.ajax({
            type: 'post',
            url: '<?=$Router->writelink(3)?>', // Путь к PHP-файлу, обрабатывающему запрос
            data: {
