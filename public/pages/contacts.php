                    ...
                    <div class="flex-row gap-30 contacts_info_blocks">
                        ...
                        <div class="col-xl-6">
                            <div class="contact_img">
                                <img src="/public/upload/wellcome/<?=$contactInfo['image']?>" alt="contact_image" class="fit_img">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="contacts_messagers flex_ac">
                                            <a href="<?=$GLOBALS['site_settings']['VIBER']?>" class="m_link" target="_blank">
                                                <img src="/public/images/common/viber.svg" alt="" class="fit_img">
                                            </a>
                                            <a href="<?=$GLOBALS['site_settings']['TELEGRAM']?>" class="m_link" target="_blank">
                                                <img src="/public/images/common/telegram.svg" alt="" class="fit_img">
                                            </a>
                                            <a href="<?=$GLOBALS['site_settings']['FB']?>" class="m_link" target="_blank">
                                                <img src="/public/images/common/facebook.svg" alt="" class="fit_img">
                                            </a>
                                            <a href="<?=$GLOBALS['site_settings']['INST']?>" class="m_link" target="_blank">
                                                <img src="/public/images/common/instagram.svg" alt="" class="fit_img">
                                            </a>
                                        </div>
                                    </div>
                                </div>
