...
<section class="pass_info-section">
    ...
    ';
            ...
            $passenger_pdf_path = $_SERVER['DOCUMENT_ROOT'] . '/tickets_pdf/ticket_' . $orderInfo['id'] . '_passenger_' . ($index + 1) . '.pdf';
    ...
    sendEmailWithAttachment($pdf_files, $orderInfo, $ticketInfo, $from_city, $from_stop, $to_city, $to_stop);


    return $pdf_files; // Возвращаем путь к сохраненному файлу
}

function sendEmailWithAttachment($pdf_files, $orderInfo, $ticketInfo, $from_city, $from_stop, $to_city, $to_stop) {
