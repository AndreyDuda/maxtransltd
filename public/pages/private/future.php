<? if (!$User->auth) {
    header('Location:' . $Router->writelink(1));
} ?>
    ...
    <div class="content">
        ...
        <div class="page_content_wrapper">
            <? /*<div class="container">
                ...
                <div class="sort_block hidden-md hidden-sm hidden-xs">
                    <div class="sort_block_tile h3_title"><?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_SORTUVATI'] ?></div>
                    <div class="sort_options flex_ac">
                        <button class="sort_option h5_title flex_ac">
                            <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_DATA'] ?>
                            <img src="/public/images/common/blue_arrows.svg" alt="arrows">
                        </button>
                        <button class="sort_option h5_title flex_ac">
                            <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_CHAS_VIDPRAVLENNYA'] ?>
                        </button>
                        <button class="sort_option h5_title flex_ac">
                            <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_CHAS_PRIBUTTYA'] ?>
                        </button>
                    </div>
                </div>
                <div class="mobile_sort hidden-xxl hidden-xl hidden-lg col-xs-12">
                    <select class="mobile_sort_select h5_title">
                        <option value="" hidden selected
                                disabled><?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_SORTUVATI'] ?></option>
                        <option value=""><?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_DATA'] ?></option>
                        <option value=""><?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_CHAS_VIDPRAVLENNYA'] ?></option>
                        <option value=""><?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_CHAS_PRIBUTTYA'] ?></option>
                    </select>
                </div>
                                    ...
                                    <div class="ticket_card flex-row private_ticket shadow_block" data-id="<?=$futureRide['id']?>">
                                        ...
                                        <div class="hidden-xxl hidden-xl hidden-lg col-sm-12 hidden-xs">
                                            <div class="ride_total_time">
                                                <div class="ticket_logo_wrapper">
                                                    <img src="/public/images/common/ticket_logo_2.svg" alt="ticket logo"
                                                         class="fit_img">
                                                </div>
...
<div class="return_thx_popup blue_popup">
    <div class="return_thx_content_wrapper">
        ...
        <div class="return_thx_img">
            <img src="/public/images/common/thx_return.png" alt="thx" class="fit_img">
        </div>
    </div>
</div>
